...
if __name__ == "__main__":
    for index in code_values:
        prefix = "[{}]".format(str(index))
        print("{}: {}".format(prefix.ljust(5, ' '), code_values[index]))
    print("---------------------------------------------------------------------")
    print("Source: https://developer.android.com/reference/android/view/KeyEvent")
    print("---------------------------------------------------------------------")
